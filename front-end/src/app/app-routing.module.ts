...
import { FaturamentoListComponent } from './faturamento/faturamento-list/faturamento-list.component';
import { FaturamentoFormComponent } from './faturamento/faturamento-form/faturamento-form.component';
...
const routes: Routes = [
  ...
  { path: 'faturamento', component: FaturamentoListComponent },
  { path: 'faturamento/novo', component: FaturamentoFormComponent  },
  { path: 'faturamento/:id', component: FaturamentoFormComponent }
];
