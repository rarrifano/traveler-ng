...
controller.listar = async (req, res) => {
    try{
        let dados = await Notas.find() // Traz todos os cursos cadastrados
...
controller.obterUm = async (req, res) => {
    try{
        ...
        let obj = await Notas.findById(id)
...
controller.atualizar = async (req, res) => {
    try{
        ...
        let ret = await Notas.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
   try{
        ...
        let ret = await Notas.findByIdAndDelete(id)
