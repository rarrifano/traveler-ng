...
controller.listar = async (req, res) => {
    try{
        let dados = await Usuarios.find() // Traz todos os cursos cadastrados
...
controller.obterUm = async (req, res) => {
    try{
        ...
        let obj = await Usuarios.findById(id)
...
controller.atualizar = async (req, res) => {
    try{
        ...
        let ret = await Usuarios.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
   try{
        ...
        let ret = await Usuarios.findByIdAndDelete(id)
